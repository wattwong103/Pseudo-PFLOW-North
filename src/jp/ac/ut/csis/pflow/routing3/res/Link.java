...
Cloneable {
    private static final long serialVersionUID = 7637573812752373124L;
    ...
    public Link(String linkid, Node tailNode, Node headNode, double length, double cost, double revCost, boolean oneway, List<LonLat> geom) {
        this._linkid = linkid;
        this._tail = tailNode;
        this._head = headNode;
        this._length = length;
