...
extends Link {
    private static final long serialVersionUID = -7075351314706609003L;
    ...
    public RailwayLink(String linkID, int lineCode, RailwayNode source, RailwayNode target, double length, List<ILonLat> geom) {
