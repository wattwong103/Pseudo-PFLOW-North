...
public class SeiDrmExample03 {
    public static void main(String[] args) throws IOException {
        ...
        Network network = new CsvSeiDrmLoader().setNetworkFile(new File(args[0])).setHeaderFlag(true).setGeometryFlag(true).load();
        long te00 = System.nanoTime();
        System.out.printf("%.09f(sec)\n", (double)(te00 - ts00) / 1.0E9);
        System.out.println(SeiDrmExample03.getMemoryInfo());
        ...
        SeiDrmExample03.printRoute(route2);
    }
